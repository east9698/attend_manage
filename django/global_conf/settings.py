"""
Django settings for attend_manage project.
...
SECRET_KEY = '^6htue97^_at_%ho*du^7)o_gtozpw(heyp&a5b4z#vm2t)p5d'
...
WSGI_APPLICATION = 'global_conf.wsgi.application'
...
LOGOUT_REDIRECT_URL = '/auth/login/' # デフォルトではリダイレクトしないようである

LOGIN_URL = '/auth/login/' # デフォルトでは/accounts/login/に飛ばされる
